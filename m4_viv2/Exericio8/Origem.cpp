...
const GLuint WIDTH = 1000, HEIGHT = 500;
...
int setupGeometry()
{
	...
	//ifstream myfile("3D_Models/Cube/cube.obj");
	//ifstream myfile("3D_Models/Suzanne/suzanneTri.obj");
	ifstream myfile("3D_Models/Suzanne/bola.obj");
	//ifstream myfile("images/suzanneTri.obj");
	while (!myfile.eof())
	{
		getline(myfile, line);
...
GLFWwindow* initializeGL()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Examples TJ", nullptr, nullptr);
	if (!window)
	{
